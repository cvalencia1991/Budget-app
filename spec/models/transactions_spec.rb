...
RSpec.describe 'Payments', type: :model do
  subject do
    @user1 = User.create(id: 1, name: 'cesar', email: 'cesar4a6z@gmail.com', password: '123456',
                         encrypted_password: '$2a$12$1Y2/Xvi3N/zUIyZilGVHQ.4iTG0PDE8gp3pn6jgpL0TgR0xi8Aegq')
